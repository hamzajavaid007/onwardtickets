            ...
            <div className="flex flex-col gap-5 reveal-right">
              ...
              <div className="flex flex-col gap-3.5">
                ...
                >
                  ...
                  >
                    <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.41.96.54 1.63.13 1.98.24.96.26 2.05.55 2.55.57 2.41.15 2.74-.25 1.02-1.12-.98-.98-2.78-1.82-5.57-1.82-4.42 0-8.6 2.16-8.6 8.6 0 .55.45 1 1 1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
                  </svg>
                  +44 77561 525115
                </a>
                {/* Email */}
